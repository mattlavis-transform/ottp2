...
class Commodity {
    ...
    calculate_vat() {
        ...
        if (this.vats.length > 1) {
            this.vat_string = "Imports of commodity <strong>" + this.goods_nomenclature_item_id + "</strong> may be subject to Value-added tax of either ";
        } else {
            this.vat_string = "Goods are subject to <a href='https://www.gov.uk/vat-rates'><abbr title='Value-added tax'>VAT</abbr></a> of ";
        }
        var index = 0;
        ...
        if (this.vats.length > 1) {
            this.vat_string += ". See <a target='_blank' href='https://www.gov.uk/guidance/rates-of-vat-on-different-goods-and-services'>VAT rates on different goods and services (opens in new tab)</a>.";
        } else {
            this.vat_string += ".";
        }
    }
    ...
    calculate_excise() {
        if (this.excises.length == 0) {
            this.excise_string = "<a target='_blank' href='https://www.gov.uk/government/publications/uk-trade-tariff-excise-duties-reliefs-drawbacks-and-allowances/uk-trade-tariff-excise-duties-reliefs-drawbacks-and-allowances'>Excise duties (opens in new tab)</a> are not chargeable on this commodity.";
        } else {
